...
public interface JerseyRequestFilter
{
    ...
    boolean service(TapestryBackedJerseyApplication endpoint, HttpServletRequest request, HttpServletResponse response, JerseyRequestHandler handler) throws IOException;
